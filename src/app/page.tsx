            ...
            <div className="flex flex-col gap-4 mt-16 mb-16">
                ...
                <form className="flex flex-col gap-4" method="POST">
                    ...
                    <div className="bg-white rounded-2xl border-zinc-300 border p-4 max-w-3xl flex flex-col gap-4">
                        ...
                        <p>
                            <strong>
                                Por favor, selecione abaixo sua profissão na
                    ...
                    <div className="bg-white rounded-2xl border-zinc-300 border p-4 max-w-3xl flex flex-col gap-4">
                        <label className="text-base font-bold italic">
                            Registro de conselho profissional relacionado à sua
                    ...
                    <div className="bg-white rounded-2xl border-zinc-300 border p-4 max-w-3xl flex flex-col gap-4">
                        <label className="text-base font-bold italic">
                            ...
                            <a
                                ...
                                target="_blank"
                            >
                                TERMOS E CONDIÇÕES DA CASA CONTENTE PARA
                                PARCERIA DE CASHBACK COM PROFISSIONAIS DE
                        ...
                        <div className="flex gap-4">
                            ...
                            />
                            <p>
                                Aceito as condições do TERMOS E CONDIÇÕES DA
                                CASA CONTENTE PARA PARCERIA DE CASHBACK COM
